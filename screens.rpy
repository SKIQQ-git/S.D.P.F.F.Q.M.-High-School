...
screen navigation():
    ...
    vbox:
        ...
        if _in_replay:
            ...
            textbutton _("Menu Princípal") action MainMenu()
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Page {}"), auto=_("Escritas Autómaticas"), quick=_("Escritas rápidas"))
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        text FileTime(slot, format=_("{#file_time}%A, %B %d %Y, %H:%M"), empty=_("espaço vázio")):
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("Português do Brasil") action Language(None)
...
screen keyboard_help():
    ...
    hbox:
        label _("Espaço")
        text _("Avança o dialogo sem selecionar escolhas.")
    ...
    hbox:
        label _("Ctrl")
        text _("Pula o dialogo enquanto o botão estiver pressionado.")

    hbox:
        label _("Tab")
        text _("Alterna o pulo de diálogo.")
    ...
    hbox:
        label _("Page Down")
        text _("Avança para o diálogo próximo dialogo.")
    ...
    hbox:
        label "S"
        text _("Guarda uma captura de tela.")

    hbox:
        label "V"
        text _("Ativa a {a=https://www.renpy.org/l/voicing}síntense de voz{/a}.")
